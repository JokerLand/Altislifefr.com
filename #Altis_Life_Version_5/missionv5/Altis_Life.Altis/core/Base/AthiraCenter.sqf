...
_veh0 = createVehicle ["cl3_civic_vti_white",[13762.973,18902.105,0],[],0,"CAN_COLLIDE"];
		_veh0 setFormDir 349.8982;
		_veh0 setDir 349.8982;
	_veh0 setPosATL [13762.973,18902.105,0.69999999];
	_veh0 setVehicleLock "LOCKED";
	_veh0 enableSimulation false; _veh0 allowDamage false; _veh0 setVectorUp [0,0,0.7]; _veh0 setObjectTextureGlobal [0, "#(rgb,8,8,3)color(0,0,0,0)"];
_veh1 = createVehicle ["cl3_taurus_silver",[13760.273,18899.16,0],[],0,"CAN_COLLIDE"];
		_veh1 setFormDir 349.8982;
		_veh1 setDir 349.8982;
	_veh1 setPosATL [13760.273,18899.16,0.64999998];
	_veh1 setVehicleLock "LOCKED";
	_veh1 enableSimulation false; _veh1 allowDamage false;  _veh1 setVectorUp [0,0,0.65]; _veh1 setObjectTextureGlobal [0, "#(rgb,8,8,3)color(0,0,0,0)"];
_veh2 = createVehicle ["cl3_q7_sand",[13757.604,18896.629,0],[],0,"CAN_COLLIDE"];
		_veh2 setFormDir 349.8982;
		_veh2 setDir 349.8982;
	_veh2 setPosATL [13757.604,18896.629,0.64999998];
	_veh2 setVehicleLock "LOCKED";
	_veh2 enableSimulation false; _veh2 allowDamage false;   _veh2 setVectorUp [0,0,0.65]; _veh2 setObjectTextureGlobal [0, "#(rgb,8,8,3)color(0,0,0,0)"];
_veh3 = createVehicle ["cl3_reventon_gold",[13754.749,18894.195,0],[],0,"CAN_COLLIDE"];
		_veh3 setFormDir 349.8982;
		_veh3 setDir 349.8982;
	_veh3 setPosATL [13754.749,18894.195,0.94999999];
	_veh3 setVehicleLock "LOCKED";
	_veh3 enableSimulation false; _veh3 allowDamage false;   _veh3 setVectorUp [0,0,0.95]; _veh3 setObjectTextureGlobal [0, "#(rgb,8,8,3)color(0,0,0,0)"];
