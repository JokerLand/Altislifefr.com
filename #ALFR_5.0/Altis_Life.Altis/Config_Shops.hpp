class WeaponShops {
    ...
    class cop_policier {
        ...
        items[] = {
            ...
            { "16Rnd_9x21_Mag", "", 50 },
            { "hgun_Sam_flashball_F", "", 2500 },
            { "ALFR_1Rnd_Flashball", "", 50 },
            { "SMG_02_F", "", 5000 },
            { "30Rnd_9x21_Mag", "", 60 },
            { "R3F_MP5A5", "", 6000 },
            { "R3F_30Rnd_9x19_MP5", "", 60 },
            { "prifle_alfr_Sam_870cms_F", "", 6500 },
            { "8Rnd_ALFR_12Gauge_Pellets", "", 80 },
            { "ALFR_Shield_F", "", 1000 }
        };
    };
    //Armurerie brigadier
    class cop_brigadier {
        ...
        items[] = {
            ...
            { "FHQ_M4A1_BLK", "", 10000 },
            { "FHQ_M4A1_AFG_BLK", "", 10000 },
            { "FHQ_M4A1_M203_BLK", "", 10000 },
            { "arifle_Sam_g36c_F", "", 10000 },
            { "30Rnd_556x45_Stanag", "", 70 },
            { "R3F_HK416M_HG", "", 12500 },
            { "R3F_30Rnd_556x45_TRACER_HK416", "", 70 },
            //Brigadier-Chef
    ...
    class cop_adjudant {
        ...
        items[] = {
            ...
            //Adj-Chef
            { "R3F_HK417L", "", 10000 },
            { "R3F_20Rnd_762x51_TRACER_HK417", "", 90 },
