...
class VirtualItems {
	...
	VITEMMACRO(francispasseport, "Passeport Falsifié (Francis Pulivan)", "francispasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(deweypasseport, "Passeport Falsifié (Dewey Wilkerson)", "deweypasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(halpasseport, "Passeport Falsifié (Hal Hansen)", "halpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(craigpasseport, "Passeport Falsifié (Craig Feldspar)", "craigpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(ericpasseport, "Passeport Falsifié (Eric Kenarban)", "ericpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(joshuapasseport, "Passeport Falsifié (Joshua Harris)", "joshuapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(dougpasseport, "Passeport Falsifié (Doug Carter)", "dougpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(richardpasseport, "Passeport Falsifié (Richard Hunt)", "richardpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(anthonypasseport, "Passeport Falsifié (Anthony Mallard)", "anthonypasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(leonpasseport, "Passeport Falsifié (Leon Vance)", "leonpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(tracypasseport, "Passeport Falsifié (Tracy Petrelli)", "leonpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(nikkipasseport, "Passeport Falsifié (Nikki Bishop)", "nikkipasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(monicapasseport, "Passeport Falsifié (Monica Deveaux)", "monicapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(mariepasseport, "Passeport Falsifié (Marie Dawson)", "mariepasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(mirandapasseport, "Passeport Falsifié (Miranda Stevens)", "mirandapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(christinapasseport, "Passeport Falsifié (Christina Yung)", "christinapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(ericapasseport, "Passeport Falsifié (Erica Harris)", "ericapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")		
	VITEMMACRO(jingmeipasseport, "Passeport Falsifié (Jing-Mei Chan)", "jingmeipasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
