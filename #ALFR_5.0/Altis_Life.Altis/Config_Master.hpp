...
class Life_Settings {
	...
	allowedSavedVirtualItems[] = { "jingmeipasseport", "ericapasseport", "christinapasseport", "mirandapasseport", "mariepasseport", "monicapasseport", "nikkipasseport", "tracypasseport", "leonpasseport", "anthonypasseport", "richardpasseport", "dougpasseport", "joshuapasseport", "ericpasseport", "craigpasseport", "halpasseport", "deweypasseport", "francispasseport", "nathanpasseport", "marcelpasseport", "tompasseport", "michealpasseport", "johnpasseport", "passeport", "serflex", "pickaxe", "fuelEmpty", "fuelFull", "spikeStrip", "lockpick", "defuseKit", "storageSmall", "storageBig", "redgull", "coffee", "waterBottle", "apple", "peach", "tbacon", "donuts", "rabbitGrilled", "salemaGrilled", "ornateGrilled", "mackerelGrilled", "tunaGrilled", "mulletGrilled", "catsharkGrilled", "turtleSoup", "henGrilled", "roosterGrilled", "sheepGrilled", "goatGrilled", "barriere", "cone", "glissiere", "barstop", "lightd" };
};
...
class VirtualItems {
	...
	VITEMMACRO(michealpasseport, "STR_AltisLifeFr_michealpasseport", "michealpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(tompasseport, "STR_AltisLifeFr_tompasseport", "tompasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(marcelpasseport, "STR_AltisLifeFr_marcelpasseport", "marcelpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(marcpasseport, "STR_AltisLifeFr_marcpasseport", "marcpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(nathanpasseport, "STR_AltisLifeFr_nathanpasseport", "nathanpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(francispasseport, "STR_AltisLifeFr_francispasseport", "francispasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(deweypasseport, "STR_AltisLifeFr_deweypasseport", "deweypasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(halpasseport, "STR_AltisLifeFr_halpasseport", "halpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(craigpasseport, "STR_AltisLifeFr_craigpasseport", "craigpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(ericpasseport, "STR_AltisLifeFr_ericpasseport", "ericpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(joshuapasseport, "STR_AltisLifeFr_joshuapasseport", "joshuapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(dougpasseport, "STR_AltisLifeFr_dougpasseport", "dougpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(richardpasseport, "STR_AltisLifeFr_richardpasseport", "richardpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(anthonypasseport, "STR_AltisLifeFr_anthonypasseport", "anthonypasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(leonpasseport, "STR_AltisLifeFr_leonpasseport", "leonpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(tracypasseport, "STR_AltisLifeFr_tracypasseport", "leonpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(nikkipasseport, "STR_AltisLifeFr_nikkipasseport", "nikkipasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(monicapasseport, "STR_AltisLifeFr_monicapasseport", "monicapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
	VITEMMACRO(mariepasseport, "STR_AltisLifeFr_mariepasseport", "mariepasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(mirandapasseport, "STR_AltisLifeFr_mirandapasseport", "mirandapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(christinapasseport, "STR_AltisLifeFr_christinapasseport", "christinapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(ericapasseport, "STR_AltisLifeFr_ericapasseport", "ericapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")		
	VITEMMACRO(jingmeipasseport, "STR_AltisLifeFr_jingmeipasseport", "jingmeipasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	...
	VITEMMACRO(goldbar, "STR_Item_GoldBar", "goldBar", 12, -1, 3000, false, -1, "icons\ico_goldbar.paa")
	VITEMMACRO(blastingcharge, "STR_Item_BCharge", "blastingCharge", 20, 45000, -1, true, -1, "icons\ico_blastingCharge.paa")
	...
	VITEMMACRO(oil_processed, "STR_Item_OilP", "oilProcessed", 6, -1, 300, false, -1, "icons\ico_oil_processed.paa")
	VITEMMACRO(copper_unrefined, "STR_Item_CopperOre", "copperUnrefined", 4, -1, -1, false, -1, "icons\ico_copper_ore.paa")
	VITEMMACRO(copper_refined, "STR_Item_CopperIngot", "copperRefined", 3, -1, 115, false, -1, "icons\ico_copper.paa")
	VITEMMACRO(iron_unrefined, "STR_Item_IronOre", "ironUnrefined", 5, -1, -1, false, -1, "icons\ico_iron_ore.paa")
	VITEMMACRO(iron_refined, "STR_Item_IronIngot", "ironRefined", 3, -1, 250, false, -1, "icons\ico_iron.paa")
	VITEMMACRO(salt_unrefined, "STR_Item_Salt", "saltUnrefined", 3, -1, -1, false, -1, "icons\ico_unprocessed.paa")
	VITEMMACRO(salt_refined, "STR_Item_SaltR", "saltRefined", 1, -1, 110, false, -1, "icons\ico_salt.paa")
	VITEMMACRO(sand, "STR_Item_Sand", "sand", 3, -1, -1, false, -1, "icons\ico_sand.paa")
	VITEMMACRO(glass, "STR_Item_Glass", "glass", 1, -1, 132, false, -1, "icons\ico_glass.paa")
	...
	VITEMMACRO(cement, "STR_Item_CementBag", "cement", 5, -1, 225, false, -1, "icons\ico_cement.paa")
	...
	VITEMMACRO(cocaine_processed, "STR_Item_CocaineP", "cocaineProcessed", 4, -1, 600, true, -1, "icons\ico_cocaine.paa")
...
class Licenses {
	...
	/** Illegal **/
	LICENSEMACRO(rebel,"STR_License_Rebel","rebel",-1,true,"civ")
