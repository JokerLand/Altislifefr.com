...
class VirtualItems {
	...
	VITEMMACRO(tracypasseport, "STR_AltisLifeFr_leonpasseport", "leonpasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(nikkipasseport, "STR_AltisLifeFr_nikkipasseport", "nikkipasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")	
	VITEMMACRO(monicapasseport, "STR_AltisLifeFr_nikkipasseport", "monicapasseport", 3, 60000, -1, true, -1, "textures\Passeport.paa")
