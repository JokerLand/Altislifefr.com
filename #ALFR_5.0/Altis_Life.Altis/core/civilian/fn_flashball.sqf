...
if(_shooter isKindOf "Man" && alive player) then
{
	if(!life_isdowned) then
	{
		...
		[[0,"%1 à été neutralisé par %2 avec un flashball.",true,[profileName, _shooter getVariable["realname",name _shooter]]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
