...
_hasVehRadar = (vehicle player) getVariable ["copVeh",false];

if((_vehicle isKindOf "Car") && (((currentWeapon player) == "Radar_Gun") OR _hasVehRadar)) then
{
	switch (true) do 
	{
		case ((_speed > 10 && _speed <= 90)) : 
		{	
