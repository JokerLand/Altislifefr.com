...
if(playerSide == west) then {
	...
	if(typeOf _curTarget == "O_Truck_03_device_F") then {
		...
		_Btn4 ctrlSetText "Assurer";
		_Btn4 buttonSetAction "[life_vInact_curTarget] spawn life_fnc_insureVehicle;";
	} else {
		_Btn3 ctrlSetText "Assurer";
		_Btn3 buttonSetAction "[life_vInact_curTarget] spawn life_fnc_insureVehicle;";
