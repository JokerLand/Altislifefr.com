...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","Warm_Marker","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","ephed","boom","butane","ether","phosph","grape_1","malt","houblon","archeo_1","tabac","fossile_1"];
{
