...
if((playerSide == west) && (_type == "tracker") && (__GETC__(life_coplevel) < 5)) exitWith {hint "Vous n'avez pas le droit d'acheter cela";};
if((_type == "tracker") && (hack_state < 1)) exitWith {hint "Vous n'avez pas le droit d'acheter cela";};
if((_type == "adre") && (surv_state < 2)) exitWith {hint "Vous n'avez pas le droit d'acheter cela";};
