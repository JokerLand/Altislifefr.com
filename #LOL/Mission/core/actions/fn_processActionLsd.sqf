...
{
    case "uranium3": {["uranium3","uranium4",10000,"Purification de l'Uranium (Civ)"]};
	case "uranium3b": {["uranium3b","uranium4b",10000,"Purification de l'Uranium (Mil)"]};
    default {[]};
};
    ...
    else
{
    ...
    hint "Tu ne peux pas traiter ce produit sans license.";
    life_is_processing = false;
};