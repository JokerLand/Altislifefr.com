/*
	File: fn_serviceChopperCona.sqf
...
_search = nearestObjects[getPos air_sp1, ["Air"],5];
if(count _search == 0) exitWith {hint localize "STR_Service_Chopper_NoAir"};
if(life_cash < 55000) exitWith {hint localize "STR_Serive_Chopper_NotEnough"};
life_cash = life_cash - 55000;
...
if(!alive (_search select 0) || (_search select 0) distance air_sp1 > 10) exitWith {life_action_inUse = false; hint localize "STR_Service_Chopper_Missing"};
