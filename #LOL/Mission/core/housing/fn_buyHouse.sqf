...
if((_house getVariable["house_owned",false])) exitWith {hint "Cette maison appartient déjà à quelqu'un..."};
...
if(life_atmcash < (_houseCfg select 0)) exitWith {hint format[localize "STR_House_NotEnough",_houseCfg select 0]};
