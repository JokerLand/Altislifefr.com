...
switch (_var) do
{
	...
	case "life_inv_roadBarrier": {"Barriere"};
	case "life_inv_wheat": {"Blé"};
	case "life_inv_flour": {"Farine de Blé"};
	case "life_inv_cuff": {"Menottes Colson"};
	...
	case "license_civ_aratv": {"Employé ARA TV"};
	...
	case "license_civ_bledjanoe": {"Bratstvo Ledjanoe"};
	case "license_civ_rsdep": {"Employé R.S. Depannage"};
	case "license_civ_brinks": {"Employé de la Brinks"};
	case "license_civ_gis": {"Employé de la G.I.S"};
	case "license_civ_conatus": {"Employé de la Conatus"};
	case "license_civ_crim": {"Confiance du Contrebandier d'armes"};
	case "license_civ_flour": {"Autorisation de moudre du blé"};
	case "license_civ_olive": {"Extraction de l'huile d'olive"};
	case "license_civ_scarface": {"Membre Scarface"};
	case "license_civ_pn": {"Employé de Petit Navire"};
	case "license_civ_transevo": {"Employé de TransEvolution"};
	case "license_civ_ac": {"Membre de la Assassin's Corp"};
	case "license_civ_acog": {"Membre des A.C.O.G"};
};