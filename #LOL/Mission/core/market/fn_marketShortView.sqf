...
_text = "<t size='1.3' color='#00FF00'>Bourse</t><br/>";
...

{
	...
	_text = format["%1<br/><t size='0.8'>%2</t><br/><t size='0.9' color='#FFFF00'>%3€</t><br/>", _text,_resname, [_price] call life_fnc_numberText];
