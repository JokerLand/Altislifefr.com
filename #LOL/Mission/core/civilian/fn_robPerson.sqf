...
if(life_cash > 0) then
{
	...
	_uname = _robber getVariable["realname",name _robber];
	[2,format["Joueur %1 a été volé de %2 € par %3 [PID VOLEUR : %4]",profileName,life_cash,_uname,_upid]] call ale_fnc_logToServer;
	life_cash = 0;
