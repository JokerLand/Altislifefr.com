...
_fourriere = [_this,3,0,[0]] call BIS_fnc_param;
...
if(_impound) then
{
	...
	{
		_query = format["UPDATE vehicles SET active='0', fourriere='%3' WHERE pid='%1' AND plate='%2' LIMIT 1",_uid,_plate,_fourriere];
