...
_fourriere = [_this,4,0,[0]] call BIS_fnc_param;
...
_query = format["SELECT id, side, classname, type, pid, alive, active, plate, color FROM vehicles WHERE pid='%1' AND alive='1' AND active='0' AND side='%2' AND type='%3' AND fourriere='%4'",_pid,_side,_type,_fourriere];
