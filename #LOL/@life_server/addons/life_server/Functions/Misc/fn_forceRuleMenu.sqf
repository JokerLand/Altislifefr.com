...
_descText = format["<t font='puristaMedium' shadow='1' size='1.7'>Bienvenue</t> <t font='puristaMedium' shadow='1' color='#FF0000' size='1.7'>%1</t> <t font='puristaMedium' shadow='1' size='1.7'>!</t><br/><br/>Nous avons détécté que c'est vôtre première connexion sur Altis Life: Evolution.<br/>Prenez le temps de lire les règles, c'est important ! Ce formulaire se ré-ouvrira si les règles sont modifiées, et vous pouvez les re-consulter depuis votre menu d'inventaire.<br/<br/><br/>Cliquer sur le bouton accepté vaut pour acceptation des règles et de fait aucune excuse concernant la non-connaissance des règles ne sera acceptée.",name player];
