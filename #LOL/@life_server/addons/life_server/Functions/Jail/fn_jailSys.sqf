...
_query = format["SELECT jail_time FROM players WHERE playerid='%2' LIMIT 1", _time, getPlayerUID _unit];
...
_query = format["UPDATE players SET jail_time='%1' WHERE playerid='%2' LIMIT 1", _time, getPlayerUID _unit];
waitUntil{!DB_Async_Active};
