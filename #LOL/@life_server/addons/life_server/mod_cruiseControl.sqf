...
compileFinal "
	...
	uwg_cruise_control = uwg_cruise addAction ['Régulateur','["""""""",call mod_cruiseControlMenu,player,false] spawn BIS_fnc_MP;',[], 0, false, false, '', 'driver uwg_cruise == player'];"",
...
compileFinal "
	...
	if (_xy > 45 && _xy < 55) then {
		...
		hint parseText format [""
					<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>Régulateur</t><br/><br/>
					<t size='0.90 'font='puristaLight' align='left'>Régulateur :</t><t size='0.90 'font='puristaLight' align='left' color='#33CC00'> Activé !</t><br/><br/>
					<t size='0.90' font='puristaLight' align='left' color='#0D82DF'>Vitesse Actuelle</t><t size='0.90' font='puristaLight'align='right' color='#0D82DF'>Vitesse Régulateur</t><br/>
					...
					<t size='0.90' font='puristaLight' align='center' color='#CC9900'>Arrêtez le régulateur en freinant (S)</t><br/><br/>
					<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>- Régulateur -</t><br/>""
				];
	};
	if (_xy > 65 && _xy < 75) then {
		...
		hint parseText format [""
					<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>Régulateur</t><br/><br/>
					<t size='0.90 'font='puristaLight' align='left'>Régulateur :</t><t size='0.90 'font='puristaLight' align='left' color='#33CC00'> Activé !</t><br/><br/>
					<t size='0.90' font='puristaLight' align='left' color='#0D82DF'>Vitesse Actuelle</t><t size='0.90' font='puristaLight'align='right' color='#0D82DF'>Régulateur</t><br/>
	...
	if (_xy > 155 && _xy < 165) then {
		...
		hint parseText format [""
					<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>Régulateur</t><br/><br/>
					<t size='0.90 'font='puristaLight' align='left'>Cruise Control:</t><t size='0.90 'font='puristaLight' align='left' color='#33CC00'> Activé !</t><br/><br/>
					<t size='0.90' font='puristaLight' align='left' color='#0D82DF'>Vitesse Actuelle</t><t size='0.90' font='puristaLight'align='right' color='#0D82DF'>Régulateur</t><br/>
					<t size='0.90' font='puristaLight' align='left'>45 - 55 km/h :</t><t size='0.90' font='puristaLight'align='right'>50 km/h</t><br/>
					<t size='0.90' font='puristaLight' align='left'>65 - 75 km/h :</t><t size='0.90' font='puristaLight'align='right'>70 km/h</t><br/>
					<t size='0.90' font='puristaLight' align='left'>115 - 125 km/h :</t><t size='0.90' font='puristaLight'align='right'>120 km/h</t><br/>
	...
	if (!cruiseControlSet) then {
		hint parseText format [""
					<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>Régulateur</t><br/><br/>
					<t size='0.90 'font='puristaLight' align='left'>Régulateur :</t><t size='0.90 'font='puristaLight' align='left' color='#990000'> NON ACTIVE !</t><br/><br/>
					<t size='0.90' font='puristaLight' align='left' color='#0D82DF'>Vitesse Actuelle</t><t size='0.90' font='puristaLight'align='right' color='#0D82DF'>Régulateur</t><br/>
					<t size='0.90' font='puristaLight' align='left'>45 - 55 km/h :</t><t size='0.90' font='puristaLight'align='right'>50 km/h</t><br/>
					<t size='0.90' font='puristaLight' align='left'>65 - 75 km/h :</t><t size='0.90' font='puristaLight'align='right'>70 km/h</t><br/>
					<t size='0.90' font='puristaLight' align='left'>115 - 125 km/h :</t><t size='0.90' font='puristaLight'align='right'>120 km/h</t><br/>
		...
		(findDisplay 46) displayAddEventHandler [""KeyDown"",""
			...
			if (_keyDown == 0x1F) then {
				if (cruiseControlSet) then {
					...
					hint parseText format [""""
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>Régulateur</t><br/><br/>
								<t size='0.90 'font='puristaLight' align='left'>Régulateur :</t><t size='0.90 'font='puristaLight' align='left' color='#990000'> Désactivé !</t><br/><br/>
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>- Régulateur -</t><br/>""""
							];
				};
			};""];
	...
	while {cruiseControlSet} do {
		if (getDammage uwg_cruise > 0.1) exitWith {
			...
			hint parseText format [""
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>Régulateur</t><br/><br/>
								<t size='0.90 'font='puristaLight' align='left'>Régulateur :</t><t size='0.90 'font='puristaLight' align='left' color='#990000'> Desactivé !</t><br/><br/>
								<t size='0.90 'font='puristaLight' align='left'>Ce véhicule est trop endommagé.<br/><br/>
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>- Régulateur -</t><br/>""
							];
		};
		if (fuel uwg_cruise < 0.1) exitWith {
			...
			hint parseText format [""
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>Régulateur</t><br/><br/>
								<t size='0.90 'font='puristaLight' align='left'>Cruise Control:</t><t size='0.90 'font='puristaLight' align='left' color='#990000'> Desactivé !</t><br/><br/>
								<t size='0.90 'font='puristaLight' align='left'>Ce véhicule n'a pas assez d'essence.<br/><br/>
								<t size='1.30' font='puristaMedium' align='center' color='#0D82DF'>- Régulateur -</t><br/>""
							];
		};
