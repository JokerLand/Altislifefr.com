...
switch (_filter) do
{
	...
	case 0:
	{
		[
			...
			["rds_uniform_Woodlander1","Tenue Gangster 1",1000],
			["rds_uniform_Woodlander2","Tenue Gangster 2",1000],
			["rds_uniform_Woodlander3","Tenue Gangster 3",1000],
            ["rds_uniform_Woodlander4","Tenue Gangster 4",1000],			
