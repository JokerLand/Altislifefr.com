			...
			default
			{
				["Armurerie",
					[
						...
						["LMG_Mk200_F",nil,15000],
						["200Rnd_65x39_cased_Box",nil,500],
						["R3F_Minimi_762_HG",nil,350000],
						["R3F_100Rnd_762x51_MINIMI",nil,800],
			...
			default
			{
				["Armurerie",
					[
						...
						["16Rnd_9x21_Mag",nil,25],
						["R3F_Famas_G2_HG",nil,25500],
						["R3F_Famas_F1_HG_DES",nil,25500],
						["R3F_LAMPE_SURB_DES",nil,500],
						["R3F_AIMPOINT_DES",nil,500],
						["R3F_25Rnd_556x45_TRACER_FAMAS",nil,100],
						["LMG_Mk200_F",nil,85000],
						["200Rnd_65x39_cased_Box",nil,500],
						["FHQ_M4A1_BLK",nil,30000],
						["FHQ_M4A1_AFG_BLK",nil,30000],
						["FHQ_M4A1_M203_BLK",nil,30000],
						["30rnd_556x45_STANAG",nil,20],
						["acc_flashlight",nil,750],
						["optic_Holosight",nil,1200],
						["optic_ACO_grn_smg",nil,2000],
