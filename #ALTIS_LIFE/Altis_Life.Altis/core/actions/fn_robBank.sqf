...
if(side _robber != civilian) exitWith { hint "Vous ne pouvez pas braquer la Banque Federale!" };
_cops = (west countSide playableUnits);
if(_cops < 10) exitWith{hint "Il n'y a pas assez de policier pour braquer la Banque Federale!(10)";};
...
if(_shop getVariable ["robbed", false]) exitWith {hint "La Banque Federale a deja était braqué toute a l'heure!";};
