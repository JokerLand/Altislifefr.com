...
call this enableSimulation false;   this allowDamage false;   this addAction["Vehicule Donateur",life_fnc_vehicleShopMenu,["donator",civilian,["donator_2","donator_2_1"],"civ","Donator Shop"],0,false,false,"",'!isNil "life_donator" && {(call life_donator) > 0'];
