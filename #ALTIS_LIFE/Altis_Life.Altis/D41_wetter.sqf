		...
		if (isDedicated) then
			{
				...
				if(D41_ChanceN >=6 && D41_ChanceN <= 35 && D41_RegenCounter == 0) then
					{
						D41_Nebel = [0,0,0]; D41_Wellen = 1; D41_Vorschau = 0; D41_Regen = 0; D41_RegenCounter = 0;
						D41_WMod = round(random 9);
				...
				{
					D41_Nebel = [0,0,0]; D41_Wellen = 1; D41_Vorschau = 0; D41_Wind = [5, 5, true]; D41_Regen = 0; D41_RegenCounter = 0;
					D41_WMod = round(random 9);
				...
				{
					D41_Nebel = [0,0,0]; D41_Wellen = 1; D41_Vorschau = 0; D41_Wind = [1, 1, true]; D41_Regen = 0; D41_RegenCounter = 1;
