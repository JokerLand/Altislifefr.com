...
_SHOW_TIMER_IN_MIN = [1,5,15,30,60];	/* minutes before restart, when message is shown */
...
_adminLevel3_UIDs =
[
	'76561198081857755','76561198085115832','0'
];
_adminLevel3 =
[
	'Teleport On Map Click','Teleport - Target To Me','Teleport - Me To Target','Teleport In Facing Direction (10m steps)',
...
/*  Check CTRLs on D24   */ _C24 = false;	/* true or false */	/* will announce: BadControls count on IDD 24 or BadControl and a number */
...
/*  Check CTRLs on D49   */ _C49 = false;	/* true or false */	/* will announce: BadCTRLs on 49 */
