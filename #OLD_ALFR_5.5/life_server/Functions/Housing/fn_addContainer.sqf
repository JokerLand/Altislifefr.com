...
_query = format["INSERT INTO containers (pid, pos, classname, inventory, gear, owned, dir, map) VALUES('%1', '%2', '%3', '""[[],0]""', '""[]""', '1', '%4','1')",_uid,_containerPos,_className,_dir];
...
_query = format["SELECT id FROM containers WHERE pos='%1' AND pid='%2' AND owned='1' AND map='1'",_containerPos,_uid];
