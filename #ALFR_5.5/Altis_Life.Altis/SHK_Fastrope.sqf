...
#define MAX_ALTITUDE_ROPES_AVAIL 95
#define MIN_ALTITUDE_ROPES_AVAIL 5
#define MAX_SPEED_ROPES_AVAIL 70

#define ROPE_LENGTH 100

#define STR_TOSS_ROPES "Déployer les cordes"
#define STR_FAST_ROPE "Descente en rappel"
#define STR_CUT_ROPES "Replier les cordes"

#define STR_JOIN_QUEUE_HINT "Patientez . . ."
...
SHK_Fastrope_Helis = [
  ...
  //EC635 ALFR
  ["EC635_Unarmed",["LeftDoor","RightDoor"],[[-1.15,0.2,-1.80],[1.25,0.2,-1.80]]], //EC635
