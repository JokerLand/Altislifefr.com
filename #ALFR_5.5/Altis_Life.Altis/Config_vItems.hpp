...
class VirtualItems {
    ...
    class barriere {
        variable = "barriere";
        displayName = "STR_AltisLifeFr_barriere";
        weight = 2;
        buyPrice = 0;
        sellPrice = 0;
        illegal = false;
    ...
    class cone {
        variable = "cone";
        displayName = "STR_AltisLifeFr_Cone";
        weight = 2;
        buyPrice = 0;
        sellPrice = 0;
        illegal = false;
    ...
    class glissiere {
        variable = "glissiere";
        displayName = "STR_AltisLifeFr_glissiere";
        weight = 2;
        buyPrice = 0;
        sellPrice = 0;
        illegal = false;
    ...
    class barstop {
        variable = "barstop";
        displayName = "STR_AltisLifeFr_barstop";
        weight = 2;
        buyPrice = 0;
        sellPrice = 0;
        illegal = false;
    ...
    class lightd {
        variable = "lightd";
        displayName = "STR_AltisLifeFr_lightd";
        weight = 2;
        buyPrice = 0;
        sellPrice = 0;
        illegal = false;
    ...
    class serflex {
        variable = "serflex";
        displayName = "STR_AltisLifeFr_serflex";
        weight = 2;
        buyPrice = 0;
        sellPrice = 0;
        illegal = false;
