...
FAR_Player_Actions =
{
	if (alive player && player isKindOf "Man") then 
	{
		...
		player addAction ["<t color=""#C90000"">" + "Se Suicider" + "</t>", "FAR_revive\FAR_handleAction.sqf", ["action_suicide"], 9, false, true, "", "call FAR_Check_Suicide"];
...
FAR_Drag =
{
	...
	_id = player addAction ["<t color=""#C90000"">" + "Lacher" + "</t>", "FAR_revive\FAR_handleAction.sqf", ["action_release"], 10, true, true, "", "true"];
	
	hint "Appuie sur 'C' si tu ne peux pas bouger.";
