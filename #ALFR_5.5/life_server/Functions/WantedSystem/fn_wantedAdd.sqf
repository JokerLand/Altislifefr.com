...
switch(_type) do
{
	...
	case "215": {_type = ["Tentative vol vehicule",5000]};
	case "213": {_type = ["Use of illegal explosives",10000]};
	case "211": {_type = ["Vol avec arme",20000]};
	case "207": {_type = ["Kidnapping",3500]};
	case "207A": {_type = ["Attempted Kidnapping",2000]};
	case "487": {_type = ["Vol de vehicule",15000]};
	case "488": {_type = ["Petty Theft",700]};
	case "480": {_type = ["Hit and run",1300]};
	case "481": {_type = ["Possesion de drogue",60000]};
	case "482": {_type = ["Intention de drogue",60000]};
	case "483": {_type = ["Traffic de drogue",60000]};
