...
/* Database Related Settings */
    ...
    saved_virtualItems[] = { "pickaxe","fuelEmpty","axe","fuelFull", "spikeStrip", "crowbar", "telecommande", "gpsTracker", "gpsTrackerreb", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat","defibrillator","toolkit" }; //Array of virtual items that can be saved on your player.
...
/* System Settings */
    ...
    clothing_masks[] = { "H_ShemagOpen_tan", "H_Shemag_olive", "H_ShemagOpen_khk", "H_Shemag_tan", "H_Shemag_olive_hs", "H_Hat_Face_Balaclava_T", "H_Hat_Face_Wrap_Black", "H_Hat_Face_Wrap_Dark", "H_Hat_Face_Wrap_Gold", "H_Hat_Face_Wrap_White", "H_Hat_Face_Wrap_DPM", "H_Hat_Face_Wrap_Flecktarn", "H_Hat_Face_Wrap_Sand", "H_Hat_Kufiya_B", "H_Hat_Kufiya_D", "H_Hat_Kufiya", "H_Hat_Kufiya_F", "H_Hat_Kufiya_G", "H_Hat_Kufiya_R", "H_Hat_Face_Cover", "H_Hat_Face_Cover_Gold", "H_Hat_Face_Cover_Green", "H_Hat_Face_Wrap_Red", "H_PilotHelmetHeli_I", "G_Balaclava_blk", "G_Balaclava_lowprofile", "G_Balaclava_combat", "G_Balaclava_oli", "G_Bandanna_aviator", "G_Bandanna_beast", "G_Bandanna_tan", "G_Bandanna_sport", "G_Bandanna_blk", "G_Bandanna_oli", "G_Bandanna_shades", "G_Bandanna_tan", "G_Bandanna_khk", "G_Bandanna_oli", "G_Bandanna_blk", "G_Bandanna_beast", "G_Balaclava_oli", "H_RacingHelmet_1_white_F", "H_RacingHelmet_1_blue_F", "H_RacingHelmet_2_F", "H_RacingHelmet_1_F", "H_RacingHelmet_1_yellow_F", "H_RacingHelmet_1_black_F", "H_RacingHelmet_1_orange_F", "H_RacingHelmet_3_F", "H_RacingHelmet_1_red_F", "H_RacingHelmet_1_green_F", "G_JaKdo_Balaclava_Tan", "jakdo_balaclava_tan", "G_JaKdo_Balaclava_Oliv", "jakdo_balaclava_numqam", "jakdo_balaclavas_oliv", "jakdo_balaclava_BLK", "U_I_FullGhillie_ard", "U_O_FullGhillie_ard", "U_B_FullGhillie_ard", "U_O_T_FullGhillie_tna_F", "U_B_T_FullGhillie_tna_F", "U_I_FullGhillie_lsh", "U_O_FullGhillie_lsh", "U_B_FullGhillie_lsh", "U_I_FullGhillie_sard", "U_O_FullGhillie_sard", "U_B_FullGhillie_sard", "U_B_T_Sniper_F" , "U_O_T_Sniper_F", "U_GhillieSuit_D", "U_GhillieSuit_F", "U_GhillieSuit_C" , "U_GhillieSuit_B", "U_GhillieSuit_E", "U_GhillieSuit_A", "U_I_GhillieSuit" , "U_O_GhillieSuit", "U_B_GhillieSuit", "H_ALFR_PaintballMsk", "H_ALFR_Metal_Gasmask_RU_blk", "H_ALFR_Metal_Gasmask_RU_oli", "H_ALFR_Metal_Gasmask_RU_grey", "H_ALFR_Metal_Gasmask_RU_khk", "H_ALFR_Metal_Gasmask_RU_fuckyou", "H_ALFR_Gasmask", "H_ALFR_Metal_Facemask_blk", "H_ALFR_Metal_Facemask_oli", "H_ALFR_Metal_Facemask_sand", "H_ALFR_Metal_Facemask_gry", "H_ALFR_Heist_Mask_1", "H_ALFR_Heist_Mask_2", "H_ALFR_Heist_Mask_3", "H_ALFR_Heist_Mask_4", "H_ALFR_Heist_Mask_5", "H_ALFR_Heist_Mask_6", "H_ALFR_Heist_Mask_7", "H_ALFR_Samurai_Mask", "H_ALFR_Sheep_Mask", "H_ALFR_Dallas_Mask", "H_ALFR_DinoMask", "H_ALFR_HorseMask", "H_ALFR_HorseMask_2", "H_ALFR_HorseMask_blk", "H_ALFR_HorseMask_pnk", "H_ALFR_OVERKILL_I", "H_ALFR_OVERKILL_II", "H_ALFR_OVERKILL_III", "H_ALFR_OVERKILL_IV", "kio_skl_msk_grn", "kio_skl_msk_red", "kio_skl_msk" };
    ...
    revive_fee = 2200; //Revive fee that players have to pay and medics only EMS(independent) are rewarded with this amount.
    ...
    vehicleShop_rentalOnly[] = { "B_MRAP_01_hmg_F" }; //Vehicles that can only be rented and not purchased. (Last only for the session)
    ...
    vehicle_rental_multiplier_COP = .05; //Cop Vehicle Rental Price = Config_Vehicle price * multiplier
    ...
    vehicle_sell_multiplier_COP = .005; //Cop Vehicle Garage Sell Price = Vehicle Buy Price * multiplier
    vehicle_sell_multiplier_MEDIC = .005; //Medic Vehicle Garage Sell Price = Vehicle Buy Price * multiplier
