...
_welcomeMessage = format["Bienvenue sur Tanoa-LifeFr.com %1",format["%1", name player]];
_camDistance = 40;
...
_role1 = "Bienvenue sur Tanoa-LifeFr.com";
_role1names = ["Server only FR"];
_role2 = "Site/Forum";
_role2names = ["www.Tanoa-LifeFr.com"];
_role3 = "TeamSpeak3";
_role3names = ["ts3.tanoa-lifefr.com"];
_role4 = "Attention";
_role4names = ["Aucun freekill, dupli, glitch, ne sera toléré !"];
