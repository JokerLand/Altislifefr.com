...
_spikeStrip = nearestOBject [player, "ALFR_Herse_F"];
...
*/
	...
	*/
	...
	case 41:
	{
		...
		{
			if((_player distance _barriere < 8) || (_player distance _barrierelumineuse < 8) || (_player distance _barrierel < 8) || (_player distance _cordon < 8) || (_player distance _barstop < 8) || (_player distance _cone < 8) || (_player distance _conel < 8) || (_player distance _panneau < 8) || (_player distance _panneauattention < 8) || (_player distance _spikeStrip < 8)) then
			{
				deleteVehicle _barriere;
                deleteVehicle _barrierelumineuse;
