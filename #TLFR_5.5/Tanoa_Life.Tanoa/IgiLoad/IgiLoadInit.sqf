...
cutText ["Depannage Service en cours d'initialisation. Patientez...","PLAIN",2];
sleep (random 30);

cutText [Format ["Depannage Service init Player: %1", Player],"PLAIN",2];
...
cutText ["Depannage Service loaded.","PLAIN",2];
