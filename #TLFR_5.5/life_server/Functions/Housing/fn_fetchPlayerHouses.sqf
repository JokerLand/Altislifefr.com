...
_query = format["SELECT pid, pos, classname, inventory, gear, dir, id FROM containers WHERE pid='%1' AND owned='1' AND map='2'",_uid];
...
_query = format["SELECT pid, pos FROM houses WHERE pid='%1' AND owned='1' AND map='2'",_uid];
