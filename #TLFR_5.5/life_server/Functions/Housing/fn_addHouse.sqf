...
_query = format["INSERT INTO houses (pid, pos, owned, map) VALUES('%1', '%2', '1', '2')",_uid,_housePos];
...
_query = format["SELECT id FROM houses WHERE pos='%1' AND pid='%2' AND owned='1' AND map='2'",_housePos,_uid];
