...
[] spawn {
	...
	while {true} do
	{
		...
		((uiNamespace getVariable "altiStatusBar")displayCtrl 1000)ctrlSetText format["%3 | TS3 : 5.135.156.67 | Joueurs connectés: %2  ", round diag_fps, count playableUnits, _statusText, _counter];
	};
};
