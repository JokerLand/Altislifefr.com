...
[] spawn {
	...
	while {true} do
	{
		...
		((uiNamespace getVariable "altiStatusBar")displayCtrl 1000)ctrlSetText format["%3 | TS3 : ts3.dedizones.com:11009 | Joueurs connectés: %2  ", round diag_fps, count playableUnits, _statusText, _counter];
	};
};
