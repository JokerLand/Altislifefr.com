...
if(_diff != (parseNumber _val)) then
{
	...
	{
		hint format["%1 Vous a donné %2 mais vous ne pouvez en porter que %3 vous lui en rendez donc %4 .",_from getVariable["realname",name _from],_val,_diff,((parseNumber _val) - _diff)];
