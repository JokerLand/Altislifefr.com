class WeaponShops {
    ...
    class gang {
        ...
        items[] = {
            ...
            { "arifle_Katiba_F", "", 250000 },
            { "hlc_rifle_aks74u", "", 250000 },
            { "hlc_rifle_aks74", "", 300000 },
            { "srifle_DMR_01_F", "", 350000 },
            { "hlc_rifle_ak74", "", 200000 },
            { "hlc_rifle_ak12", "", 300000 },
            { "hlc_rifle_aks74_GL", "", 300000 },
            { "hlc_rifle_ak47", "", 350000 },
            { "hlc_rifle_akm", "", 400000 },
            { "hlc_rifle_saiga12k", "", 300000 },
            { "hlc_rifle_rpk", "", 500000 },
            { "hlc_rifle_akmgl", "", 400000 },
            { "hlc_rifle_aek971", "", 500000 },
            { "Cha_PK", "", 600000 },
            { "optic_ACO_grn", "", 3500 },
            { "hlc_optic_kobra", "", 3500 },
            { "optic_Holosight", "", 3600 },
